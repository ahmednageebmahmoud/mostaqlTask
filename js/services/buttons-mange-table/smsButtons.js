class SmsButtons {
    ...
    * @param {string} tableId معرف الجدول
    ...
    static tablePrintV2(html) {
        let newWin = window.open("", "PRINT");
        newWin.document.write(LangIsEn ? SmsButtons.cssEn : SmsButtons.cssAr + html);
...
SmsButtons.cssAr =
    ...
    <link rel="stylesheet" href="./assets/bootstrap/css/bootstrap.rtl.min.css" media="print">
